...
<div id="map"></div>
    <script>
        function initMap() {
            var pin = {lat:26.393493805155085, lng: 50.19452707284585};
            var mapOptions = {
                center : pin,
                zoom: 15
            };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDs0O_oh59uinS0iNhX2mT_UtU5fwTlJ4I&callback=initMap" async defer></script>
...
<div class="contact-container">
    ...
    <div class="contact-item">
        ...
        <h1>Email</h1>
        <p class="contact-text">
        <a href="mailto:contact@malbasy.com">contact@malbasy.com</a></p>
    </div>
</div>
